...
evi.trend <- data.frame(hex_id = evi.df$hex_id, na.cnt = NA, NA_Values = NA, Trend = NA, P_value = NA, R_Squared = NA, Standard_Error = NA, Trend_Strength = NA, Seasonal_Strength = NA) #This data frame will hold the trend data
...
```
```{r}
evi.trend$NA_Values[i] <- na.cnt #add count of na values to dataframe
