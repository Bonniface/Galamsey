...
Auto correlation factor (ACF): It is the correlation between the observations at the current time stamp and observations at the previous time stamp (Hagan, M.T. and Behr, S.M., 1987).

Partial auto correlation factor (PACF): The correlation between the observations at two different time stamps, assuming both observations are correlated to the observations at another time stamp (Hagan, M.T. and Behr, S.M., 1987).
...
In this study, the submission used a quantitative approach. Instead of using subjective judgment, findings and conclusions heavily rely on the use of statistical methods and reliable time series models. \## Specification of the Model} \# Data Representation} \# The Analysis Of Variance (ANOVA) Method} \# The Empirical \* Theory model} \# Assumptions }
